...
class base
{
    ...
    public function addModifiers()
    {
        ...
        $this->tpl->addModifier(
            'limit',
            function ($data, $limit, $etc = '&hellip;', $wordcut = false) use ($config) {
        ...
        $this->tpl->addModifier(
            'image',
            function ($data, $noimage = '', $imageType = 'small', $number = 1, $size, $quality = '100', $resizeType = 'auto', $grabRemote = true, $showSmall = false, $subdir = false) use ($configForResizer) {
        ...
        $this->tpl->addModifier(
            'tinypng',
            function ($data, $noimage = '', $imageType = 'small', $number = 1, $size, $quality = '100', $resizeType = 'fit', $grabRemote = true, $showSmall = false, $subdir = false) use ($configForResizer) {
        ...
        $this->tpl->addModifier(
            'getAuthors',
            function ($data, $fields = false) use ($db) {
        ...
        $this->tpl->addModifier(
            'catinfo',
            function ($data, $info = false, $noicon = false) {
